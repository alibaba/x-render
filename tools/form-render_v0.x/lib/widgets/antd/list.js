...
var _PlusCircleOutlined2 = _interopRequireDefault(require("@ant-design/icons/lib/icons/PlusCircleOutlined"));
...
function FrButton(_ref) {
  ...
  try {
    if (isComponent(IconComponent)) {
      iconElement = /*#__PURE__*/_react.default.createElement(IconComponent, null);
    }
  } catch (error) {}
...
var ListWithModal = function ListWithModal(props) {
  ...
  if (options && options.modal) {
    ...
    return /*#__PURE__*/_react.default.createElement("div", null, /*#__PURE__*/_react.default.createElement("a", {
      className: "pointer",
      onClick: toggle
    }, text && typeof text === 'string' ? '+ ' + text : '+ 配置'), /*#__PURE__*/_react.default.createElement("span", null, "\uFF08", arrLength, "\u6761\u6570\u636E\uFF09"), /*#__PURE__*/_react.default.createElement(_modal.default, _extends({
