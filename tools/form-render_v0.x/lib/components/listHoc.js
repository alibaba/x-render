  ...
  return /*#__PURE__*/function (_React$Component) {
    ...
    _createClass(_class2, [{
      ...
      value: function render() {
        ...
        var descProps = _objectSpread(_objectSpread({}, p), {}, {
          index: name
        });
        ...
        if (_isFunction) {
          ...
          if (typeof _isFunction === 'string') {
            hideDelete = (0, _utils.evaluateString)(_isFunction, formData, rootValue);
        ...
        return /*#__PURE__*/_react.default.createElement("li", {
          className: setClass
        }, hideIndex ? null : /*#__PURE__*/_react.default.createElement("div", {
        ...
        }, name + 1), canFold && fold && isSchemaObj ? /*#__PURE__*/_react.default.createElement(_descList.default, descProps) : item, /*#__PURE__*/_react.default.createElement("div", {
          className: "fr-item-actions"
        }, canFold && /*#__PURE__*/_react.default.createElement(_foldIcon.default, {
          fold: fold,
          onClick: this.toggleFold,
          className: "fr-item-action-icon"
        }), readOnly || !hideDelete ? /*#__PURE__*/_react.default.createElement("div", {
          className: "fr-item-action-icon",
          ...
          alt: "delete"
        })) : null, !readOnly && /*#__PURE__*/_react.default.createElement(DragHandle, null)), !(canFold && fold || readOnly) && /*#__PURE__*/_react.default.createElement("div", {
...
var fieldListHoc = function fieldListHoc(ButtonComponent, Pagination) {
  var SortableItem = (0, _reactSortableHoc.SortableElement)(listItemHoc(ButtonComponent));
  return /*#__PURE__*/function (_React$Component2) {
    ...
    _createClass(_class4, [{
      ...
      function render() {
        ...
        }, showPagination ? /*#__PURE__*/_react.default.createElement(Pagination, {
          size: "small",
          total: total,
          pageSize: pageSize,
        ...
        }) : /*#__PURE__*/_react.default.createElement("div", null), !readOnly && /*#__PURE__*/_react.default.createElement("div", {
          className: "tr"
        }, canAdd && /*#__PURE__*/_react.default.createElement(ButtonComponent, {
          icon: "add",
...
function listHoc(ButtonComponent, Pagination) {
  ...
  var SortableList = (0, _reactSortableHoc.SortableContainer)(fieldListHoc(ButtonComponent, Pagination));
  return _temp = _class5 = /*#__PURE__*/function (_React$Component3) {
    ...
    function _class5(_props) {
      ...
      _this3.handleSort = function (_ref2) {
        ...
        onChange(name, (0, _reactSortableHoc.arrayMove)(value, oldIndex, newIndex));

        _this3.setState({
          foldList: (0, _reactSortableHoc.arrayMove)(_this3.state.foldList, oldIndex, newIndex)
        });
      };
    ...
    return _class5;
  }(_react.default.Component), _class5.propTypes = {
