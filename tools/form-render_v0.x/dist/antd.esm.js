...
var RangeHoc = (function (_ref) {
  ...
  var _value = start && end ? [moment(start, _format), moment(end, _format)] : [];
...
function dateRange(p) {
  ...
  var hocProps = _objectSpread2(_objectSpread2({}, p), {}, {
    onChange: onChange,
...
function input(p) {
  ...
  var config = _objectSpread2(_objectSpread2({}, _options), {}, {
    maxLength: maxLength,
    suffix: suffix
  });
...
function FrButton(_ref) {
  ...
  return /*#__PURE__*/React.createElement(_Button, _extends({}, rest, {
    size: "small",
    icon: iconElement
  }), children);
}
...
var ListWithModal = function ListWithModal(props) {
  ...
  if (options && options.modal) {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
      className: "pointer",
      onClick: toggle
    }, text && typeof text === 'string' ? '+ ' + text : '+ 配置'), /*#__PURE__*/React.createElement("span", null, "\uFF08", arrLength, "\u6761\u6570\u636E\uFF09"), /*#__PURE__*/React.createElement(_Modal, _extends({
...
var MapWithModal = function MapWithModal(props) {
  ...
  if (options && options.modal) {
    ...
    return /*#__PURE__*/React.createElement("div", null, /*#__PURE__*/React.createElement("a", {
      className: "pointer",
      onClick: toggle
    }, text && typeof text === 'string' ? '+ ' + text : '+ 配置'), /*#__PURE__*/React.createElement(_Modal, _extends({
      title: schema && schema.title || '子配置',
      visible: show,
      onCancel: toggle,
      footer: null,
...
function upload(_ref) {
  ...
  }, /*#__PURE__*/React.createElement(_Upload, props, /*#__PURE__*/React.createElement(_Button, {
    icon: /*#__PURE__*/React.createElement(_UploadOutlined, null)
  }, "\u4E0A\u4F20")), value && /*#__PURE__*/React.createElement("a", {
    href: value,
    target: "_blank",
...
var AntdForm = function AntdForm(_ref, ref) {
  var _ref$mapping = _ref.mapping,
      ...
      rest = _objectWithoutProperties(_ref, ["mapping", "widgets", "configProvider"]);

  return /*#__PURE__*/React.createElement(_ConfigProvider, _extends({}, configProvider, {
    locale: zhCN
  }), /*#__PURE__*/React.createElement(FormRender$1, _extends({
