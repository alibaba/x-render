...
import _TimePicker from '@alifd/next/lib/time-picker';
import _DatePicker from '@alifd/next/lib/date-picker';
...
import _Range from '@alifd/next/lib/range';
import _Switch from '@alifd/next/lib/switch';
...
function date(p) {
  ...
  var DateComponent = _DatePicker;

  if (format === 'time') {
    DateComponent = _TimePicker;
  } else {
    switch (picker) {
      case 'month':
...
function dateRange(_ref) {
  ...
  var dateFormat = getFormatForFusion(_format);
  var formatBack = getFormat(_format);
