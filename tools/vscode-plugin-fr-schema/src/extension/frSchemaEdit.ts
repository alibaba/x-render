...
export class frSchemaEditProvider {
  public static register(): vscode.Disposable {
    return vscode.commands.registerCommand(frSchemaEditProvider.viewType, (uri: vscode.Uri) => {
      let resource = uri;
      ...
      const editor = vscode.window.activeTextEditor ? 'frSchema.editor' : 'default';
