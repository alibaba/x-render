...
const snippets = [
  {
    title: '下拉单选',
    screenshot: 'https://img.alicdn.com/imgextra/i1/O1CN01MNMs5X24pZX9z2QSl_!!6000000007440-2-tps-274-382.png',
    schema: {
  ...
  {
    title: '下拉多选',
    screenshot: 'https://img.alicdn.com/imgextra/i4/O1CN01kma8S21I3OJIuFZZy_!!6000000000837-2-tps-1286-632.png',
    schema: {
      componentName: 'Select',
      props: {
        title: '下拉多选',
