  ...
  const html = `
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://g.alicdn.com/fone-lowcode/fr-generator/1.0.0-alpha.22/css/index.css" />
      ...
      <body>
        ...
        <script type="text/javascript" src="https://g.alicdn.com/fone-lowcode/fr-generator/1.0.0-alpha.22/js/index.js"></script>
      </body>
    </html>
  `;
  return html;
