  ...
  const html = `
    <html>
      <head>
        ...
        <link rel="stylesheet" href="https://g.alicdn.com/fone-lowcode/fr-generator/1.0.6/css/index.css" />
      ...
      <body>
        ...
        <script type="text/javascript" src="https://g.alicdn.com/fone-lowcode/fr-generator/1.0.6/js/index.js"></script>
      </body>
    </html>
  `;
  return html;
