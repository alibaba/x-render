...
| ---------------- | :-----------------: | :------: | :------: | :----------------------------------------------------------------------------------: |
| **schema**       |      `Object`       |    ✓     |    {}    |                  详见 [schema 配置](/form-render/config/schema.md)                   |
| **uiSchema**     |      `Object`       |          |    {}    | 详见 [uiSchema 配置](/form-render/config/uiSchema.md)（**一般建议合并到 `schema`**） |
...
[详见“不常用 props”](/form-render/config/props.md)
