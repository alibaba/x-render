...
import { Form, Row, ConfigProvider, Button } from 'antd';
  ...
  properties: {
    activityApplyInfo: {
      properties: {
        ...
        exchangeType: {
          enum: ['SHOPPING_COUPON', 'STORE_RIGHT', 'BRAND_RIGHT', 'POINT_CASH'],
          enumNames: [
            '积分兑换购物券',
            '积分兑换门店权益',
            '积分兑换品牌权益',
    ...
    activityBasicInfo8: {
      properties: {
        ...
        limitUpper: {
          ...
          type: 'number',
          hidden:
            '{{formData.activityBasicInfo.userLimitType === "UNLIMITED"}}',
        },
        userIdentity: {
          enum: ['member', 'member365'],
          enumNames: ['全部可领', '仅365会员'],
          props: {},
          title: '可领用户类型',
          required: true,
          type: 'string',
    ...
    activityRuleInfo: {
      properties: {
        ...
        activityType: {
          enum: ['POINT_CASH', 'POINT_EXCHANGE'],
          enumNames: ['积分加钱购', '积分兑换'],
          props: {
            value:
              '{{formData.activityApplyInfo.exchangeType === "POINT_CASH" ? "POINT_CASH" : "POINT_EXCHANGE"}}',
          },
          title: '活动类型',
          readOnly: true,
          type: 'string',
        ...
        costPointNumber: {
          ...
          type: 'number',
          hidden:
            '{{formData.activityApplyInfo.exchangeType === "POINT_CASH"}}',
        },
      },
      props: {},
      title: '活动规则',
