...
export interface ICRBarProps extends ICommonProps, Omit<BarConfig, keyof ICommonProps | 'xField' | 'yField' | 'seriesField'> {

};

const CRBar: React.FC<ICRBarProps> = ({
  className,
  style,
  meta = [],
  data = [],
  ...
  return (
    // 很有意思，就是 Column 图互换一下 x、y Field
    <Bar
      data={chartData}
      isGroup={isGroup}
      yField={xField}
