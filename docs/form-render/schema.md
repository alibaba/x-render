...
1. 如果每个 item 数据 1-2 条，且没有复杂结构（例如对象、列表），建议使用 widget: simple
2. 如果每个 item 数据 3-5 条，且没有复杂结构（例如对象、列表），建议使用 widget: table
3. 如果每个各 item 数据量大，或者结构复杂，建议使用 widget: list
